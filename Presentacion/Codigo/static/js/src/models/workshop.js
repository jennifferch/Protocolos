...
Workshop.prototype.getBlocks = function() {
    ...
    let workshopBlocks = this.data.workshop_blocks || [];
    let exerciseBlocks = this.data.exercises[this.currentExercise].exercise_blocks || [];
    ...
    this.getComponentClasses().forEach(classname => {
        ...
        // get the component as well as any potential generators
